...
function initDataTable() {
  ...
  $(document).on('click', '.groupRow', function () {
    ...
    $("#deleteSelectedRows").text("<?= _("Remove")?> (" + selectedRows + ") <?= _("Members from group")?>");
    $("#buttonDropdown").prop('disabled', !(selectedRows));
    $("#addSelectedToGroup").prop('disabled', !(selectedRows));
    $("#addSelectedToGroup").html("<?= _("Add")?>  (" + selectedRows + ") <?= _("Members to another group")?>");
    $("#addSelectedToCart").prop('disabled', !(selectedRows));
    $("#addSelectedToCart").html("<?= _("Add")?>  (" + selectedRows + ") <?= _("Members to cart")?>");
    $("#moveSelectedToGroup").prop('disabled', !(selectedRows));
    $("#moveSelectedToGroup").html("Move  (" + selectedRows + ") <?= _("Members to another group")?>");
  });
