...
$(document).ready(function () {
  ...
  $("#deleteSelectedRows").click(function () {
    ...
    bootbox.confirm({
      message: "<?= gettext('Are you sure you want to remove the') ?> " + deletedRows.length + " <?= gettext("selected group members?") ?>",
      buttons: {
        confirm: {
          label: '<?= gettext("Yes") ?>',
...
function initDataTable() {
  ...
  $(document).on('click', '.groupRow', function () {
    ...
    $("#deleteSelectedRows").text("<?= gettext("Remove")?> (" + selectedRows + ") <?= gettext("Members from group")?>");
    $("#buttonDropdown").prop('disabled', !(selectedRows));
    $("#addSelectedToGroup").prop('disabled', !(selectedRows));
    $("#addSelectedToGroup").html("<?= gettext("Add") ?>  (" + selectedRows + ") <?= gettext("Members to another group") ?>");
    $("#addSelectedToCart").prop('disabled', !(selectedRows));
    $("#addSelectedToCart").html("<?= gettext("Add") ?>  (" + selectedRows + ") Members to cart");
    $("#moveSelectedToGroup").prop('disabled', !(selectedRows));
    $("#moveSelectedToGroup").html("<?= gettext("Move") ?>  (" + selectedRows + ") <?= gettext("Members to another group") ?>");
  });
}
